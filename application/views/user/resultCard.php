<body><div class="content-wrapper" >
  ...
  <img id="n"  src="<?php echo base_url()?>assets/img/d.png" width="100px" height="100px">
   ...
   <div class="col-lg-12 text-center">
          <h3>1st to 9th</h3>
 <h3>MARK SHEET  EXAM <?php echo date('d-M-Y',strtotime($date)) ?></h3>
        </div>
        ...
        <div class=col-lg-12>
          <table border=1 width="100% " height=500px; style="margin-bottom: 30px; ">
           ...
           <?php 
              ...
              $qry=$this->db->query("select * from result where std_id=$stdId and id=$id");
              $run=$qry->result();
             $totalMarks=0;
               $sr=0;
                foreach($run as $row)
...
<p>Signature of Class Incharge _______________</p><br>
        ...
        <div class="col-md-2 col-md-2">
            <button class="btn btn-success" style="margin-right:10px" id="btnPrint" onclick="window.print()">Print</button>
        </div>
</div>   
    </div>
         <?php
