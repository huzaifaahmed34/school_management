  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Show Classes</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success">
              <div class="box-header with-border">
                  <h3 class="box-title">Show Classes</h3>
                </div>
              ...
              <div class="modal-dialog modal-md" role="document">
                <div class="modal-content update-modal" >
                  <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Edit Classes</h3>
...
<!--- Add DAta-->
  <form id="form1" method="post" action="<?php echo site_url('Setup/Classadd')?>">
                ...
                <div class="modal-content update-modal" >
                  ...
                  <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <label class="col-form-label">Class: </label>
                              <input type="text" name="class1"  class="form-control" placeholder="Enter Class Name" >
                            </div>
                             <div class="col-md-6">
   ...
   function showdata(){
    $.ajax({
      type:'ajax',
        ...
        url:'<?php echo site_url('Setup/Classshow')?>',
        async:false,
        success:function(res){
          var html='';
...
sno=0;
    $.each(res,function(i,item){
      sno++;
          ...
          +sno+'</td><td>'
          +res[i].class+'</td><td>'
          +res[i].code+'</td><td><a href=javascript:; data='+res[i].id+' class=editdata></a> &nbsp;<a href=javascript:; data='+res[i].id+' class=deletedata></a></td></tr>';
        });
          $('#showdata').html(html);
        },
        error:function(){
...
$.ajax({
    ...
    url:'<?php echo site_url('Setup/Classedit')?>',
    success:function(res){
          res=JSON.parse(res);

     $.each(res,function(i,item){
 $('input[name=id]').val(res[i].id);
        $('input[name=class]').val(res[i].class);
...
$('#btnUpdate').unbind().click(function(){
        ...
        $.ajax({
            method:'post',
            data:data,
            url:'<?php echo site_url('Setup/Classupdate')?>',
            success:function(res){
...
$.ajax({
    ...
    data:{'id':id},
    datatype:'json',
    url:'<?php echo site_url('Setup/Classdelete')?>',
    success:function(res){
