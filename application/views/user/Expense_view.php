        ...
        <div class="col-xs-12">
          ...
          <div class="box box-success">
              <div class="box-header with-border">
                  <h3 class="box-title">Show Expenses</h3>
                </div>
          ...
          <div class="col-md-3" style="text-align: right; padding-top:30px;">
           <!-- /.form-group -->
                  <div class="form-group">
                    ...
                    <button href="#" data-toggle=modal data-target='#add' class="btn btn-success" title="Add Expense" style="background-color: #0092DF;
              ...
              <div class="modal-dialog modal-md" role="document">
                <div class="modal-content update-modal" >
                  <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel">Edit Expense</h3>
                  ...
                  <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <label class=" col-form-label">Expense</label>
                              <select name=class class="form-control selectclass">
                                ...
                                <option value="Others">Other Expense</option></select></div>
                                  <div class="col-md-6">
                              
                            <label class="col-form-label">Amount </label>
                              <input type="text" name="code"  class="form-control" placeholder="Enter Amount" >
                            </div>
                          </div>
...
<!--- Add DAta-->
  <form id="form1" method="post" action="<?php echo site_url('Payroll/expense_insert')?>">
                ...
                <div class="modal-content update-modal" >
                  ...
                  <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <label class="col-form-label">Amount </label>
                              <input type="text" name="code1"  class="form-control" placeholder="Enter Amount" >
                            </div>
...
showdata();
   function showdata(){
    $.ajax({
        method:'get',
        url:'<?php echo site_url('Payroll/expense_show')?>',
        dataType:'json',
        async:false,
        success:function(res){
          var html='';
...
sno++;
          ...
          +item.expense+'</td><td>'
          +item.amount+'</td><td>'
          +item.created_on+'</td><td><a href=javascript:; data='+item.id+' class=editdata>Edit</a> &nbsp;<a href=javascript:; data='+item.id+' class=deletedata>Delete</a></td></tr>';
        });
          $('#showdata').html(html);
        },
        error:function(){
...
$.ajax({
    ...
    data:{'id':id},
    datatype:'json',
    url:'<?php echo site_url('Payroll/expense_edit')?>',
    success:function(res){
     var res=JSON.parse(res);
     
$.each(res,function(i,item){
 $('input[name=id]').val(res[i].id);
  $('.selectclass option[value="'+res[i].expense+'"] ').attr('selected', 'selected');
        $('input[name=class]').val(res[i].expense);
          $('input[name=code]').val(res[i].amount);
      });
    },
});
$('#btnUpdate').unbind().click(function(){
        ...
        $.ajax({
            method:'post',
            data:data,
            url:'<?php echo site_url('Payroll/expense_update')?>',
            success:function(res){
...
$.ajax({
    ...
    data:{'id':id},
    datatype:'json',
    url:'<?php echo site_url('Payroll/expense_delete')?>',
    success:function(res){
